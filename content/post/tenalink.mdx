...
* Machine Learnig - Scikit-Learn, Numpy and Pandas
* Hardware - Arduino Uno, ECG sensor, Temprature sensor
* IDE - VScode, Arduino IDE

## **2. UI**

<CaptionedImage imgUrl="/homee.png" caption="Recommendation Page" />
